...
#define PREACT(R,LogK) \
  ...
  /* Cement hydrates dissociation reactions */
  {
    ...
    double logk_afm_bis  = LogKd(AFm__4Ca_2AlO4H4_SO4_4OH_6H2O) ;
    double logk_aftett   = LogKd(AFt_12H__6Ca_2Al_3SO4_38H2O) ;
    double logk_aftett_b = LogKd(AFt__6Ca_2AlO4H4_3SO4_4OH_26H2O) ;
