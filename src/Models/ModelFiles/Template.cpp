...
#define NVE   (5)     /*  5 explicit terms per point */
 ...
 *  Return the nb of views (scalar, vector or tensor) */
{
  ...
  Result_Store(r + 0,&scalar,"NameOfView_x",1) ; /* scalar */
  Result_Store(r + 1,vector,"NameOfView_v",3)  ; /* vector */
  Result_Store(r + 2,tensor,"NameOfView_t",9)  ; /* tensor */
